...
const images = [
  ...
  {
    filename: 'kymco-agility-125.jpg',
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Kymco_Agility_125_R16%2B.jpg/1280px-Kymco_Agility_125_R16%2B.jpg',
    make: 'Kymco',
    model: 'Agility 125',
    generations: [null],
    alt: 'Kymco Agility 125 scooter',
    attribution: 'Corvettec6r, Wikimedia Commons, CC BY 4.0',
  },
  {
    filename: 'kymco-like-125i.jpg',
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/KYMCO_LIKE_125.jpg/1280px-KYMCO_LIKE_125.jpg',
    make: 'Kymco',
    model: 'Like 125i',
    generations: [null],
    alt: 'Kymco Like 125i scooter',
    attribution: 'DuckJCV, Wikimedia Commons, CC BY-SA 4.0',
  },
  {
    filename: 'kymco-people-s-125i.jpg',
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Kymco_People_S_125.jpg/1280px-Kymco_People_S_125.jpg',
    make: 'Kymco',
    model: 'People S 125i',
    generations: [null],
    alt: 'Kymco People S 125i scooter',
    attribution: 'Corvettec6r, Wikimedia Commons, CC BY-SA 4.0',
  },
  {
    filename: 'kymco-downtown-125i.jpg',
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Kymco_Downtown_200i.jpg/1280px-Kymco_Downtown_200i.jpg',
    make: 'Kymco',
    model: 'Downtown 125i',
    generations: [null],
    alt: 'Kymco Downtown 125i scooter',
    attribution: 'Corvettec6r, Wikimedia Commons, CC BY 4.0',
  },
  {
    filename: 'kymco-downtown-300i.jpg',
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Kymco_Downtown_300i_%28cropped%29.jpg/1280px-Kymco_Downtown_300i_%28cropped%29.jpg',
    make: 'Kymco',
    model: 'Downtown 300i',
    generations: [null],
    alt: 'Kymco Downtown 300i scooter',
    attribution: 'Jhcbs1019, Wikimedia Commons, CC BY-SA 4.0',
  },
  {
    filename: 'kymco-x-town-300i.jpg',
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Kymco_X-Town_300.jpg/1280px-Kymco_X-Town_300.jpg',
    make: 'Kymco',
    model: 'X-Town 300i',
    generations: [null],
    alt: 'Kymco X-Town 300i scooter',
    attribution: 'AVMOTO, Wikimedia Commons, CC BY-SA 4.0',
  },
  {
    filename: 'kymco-ak550i.jpg',
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Kymco_AK550.jpg/1280px-Kymco_AK550.jpg',
    make: 'Kymco',
    model: 'AK 550i',
    generations: [null],
    alt: 'Kymco AK 550i maxi scooter',
    attribution: 'Corvettec6r, Wikimedia Commons, CC BY-SA 4.0',
  },
]
