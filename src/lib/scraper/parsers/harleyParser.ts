/**
 * Harley-Davidson Parser
 *
 * Parses spec pages from harley-davidson.com into structured text.
 */

import type { ParsedSection } from '../scraper.types'

export async function parseHarleyHtml(
  html: string,
  title: string
...
function cleanTitle(title: string): string {
  return title.replace(/\s*[-\u2013|]\s*Harley-Davidson.*/i, '').trim()
}
